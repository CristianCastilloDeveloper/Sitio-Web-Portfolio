...
export const metadata = {
  title: "Blog",
  description: "Artículos técnicos, perspectivas y reflexiones sobre ingeniería de software.",
}
          ...
          <Card key={post.id} className="overflow-hidden flex flex-col bg-zinc-900/50 border-zinc-800/50">
            ...
            <CardContent className="flex flex-col flex-grow p-6">
              <div className="flex items-center justify-between gap-4 mb-2">
                ...
                <ShareButton title={post.title} url={`https://cristiancastillo.com/blog/${post.slug}`} className="ml-auto" />
              </div>
