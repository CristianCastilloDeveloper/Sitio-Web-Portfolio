    ...
    <div className={className}>
      <div className="flex items-center justify-between mb-8">
        <div>
          ...
          <p className="text-muted-foreground">Algunos de mis trabajos recientes y contribuciones</p>
        </div>
        {showViewAll && (
          <Link href="/projects">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {featuredProjects.map((project, index) => (
          <Card
            key={project.id}
            className={`group overflow-hidden border-border/50 bg-card/50 backdrop-blur-sm hover:shadow-lg transition-all duration-300 hover:border-border card-hover stagger-${index + 1}`}
          >
            ...
            <CardContent className="p-6">
              ...
              <p className="text-muted-foreground mb-4 line-clamp-2 text-justify">{project.description}</p>
